...
class LanguageNative(val context: Context) : GoogleMobileAdsPlugin.NativeAdFactory {
    ...
    override fun createNativeAd(
        ...
        val nativeAdView = LayoutInflater.from(context)
            .inflate(R.layout.language_native_ad, null) as NativeAdView
        ...
        with(nativeAdView) {
            ...
            /*  advertiserView.visibility = if (nativeAd.advertiser == null) View.INVISIBLE else View.VISIBLE*/
